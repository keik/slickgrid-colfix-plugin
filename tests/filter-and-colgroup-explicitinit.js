...
describe('with DataView + filter + colgroup + explicitInitialization', function() {

  before(function() {

    /** columns defination */
    var columns = [
      {id: 'col1', name: 'col 1', field: 'col1', width: 50,  group: 'group-1'},
      {id: 'col2', name: 'col 2', field: 'col2', width: 80,  group: 'group-1'},
      {id: 'col3', name: 'col 3', field: 'col3', width: 100, group: 'group-2'},
      {id: 'col4', name: 'col 4', field: 'col4', width: 200, group: 'group-2'},
      {id: 'col5', name: 'col 5', field: 'col5', width: 50,  group: 'group-2'},
      {id: 'col6', name: 'col 6', field: 'col6', width: 300, group: 'group-3'},
      {id: 'col7', name: 'col 7', field: 'col7', width: 100, group: 'group-3'},
      {id: 'col8', name: 'col 8', field: 'col8', width: 200, group: 'group-3'},
      {id: 'col9', name: 'col 9', field: 'col9', width: 100, group: 'group-3'}
    ];
