...
function ColFix(fixedColId) {
  ...
  function initInternal() {
    ...
    _handler.subscribe(_origGrid.onActiveCellChanged, function (e, args) {
  ...
  function separateGrid() {
    ...
    _wrapper = document.createElement('div'), _innerWrapper = document.createElement('div');
